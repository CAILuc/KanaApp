...
export const aRow   = kanaData.filter(k => k.row === 'a');
export const kaRow  = kanaData.filter(k => k.row === 'ka');
export const saRow  = kanaData.filter(k => k.row === 'sa');
export const taRow  = kanaData.filter(k => k.row === 'ta');
export const naRow  = kanaData.filter(k => k.row === 'na');
export const haRow  = kanaData.filter(k => k.row === 'ha');
export const maRow  = kanaData.filter(k => k.row === 'ma');
export const yaRow  = kanaData.filter(k => k.row === 'ya');
export const raRow  = kanaData.filter(k => k.row === 'ra');
export const waRow  = kanaData.filter(k => k.row === 'wa');
export const nRow   = kanaData.filter(k => k.row === 'n');
export const gaRow  = kanaData.filter(k => k.row === 'ga');
export const zaRow  = kanaData.filter(k => k.row === 'za');
export const daRow  = kanaData.filter(k => k.row === 'da');
export const baRow  = kanaData.filter(k => k.row === 'ba');
export const paRow  = kanaData.filter(k => k.row === 'pa');
